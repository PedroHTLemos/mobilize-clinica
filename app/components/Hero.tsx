export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative w-full h-screen flex items-center justify-end text-center px-6 pb-20"
      style={{
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-end max-w-3xl text-white">
